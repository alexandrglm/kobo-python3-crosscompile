...
our %config = (
  ...
  CPPINCLUDES => [  ],
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3", "-march=armv7-a", "-mfpu=neon-vfpv4", "-mfloat-abi=hard" ],
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)arm-unknown-linux-gnueabihf-gcc",
  minor => "1.1",
  ...
  options => "--prefix=/home/dev/Desktop/ClaraColour/python/crosstoolsng/openssl-armhf-install --openssldir=/usr/lib/ssl -march=armv7-a -mfpu=neon-vfpv4 -mfloat-abi=hard enable-shared no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-tests no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.40.1",
  perlargv => [ "linux-generic32", "--prefix=/home/dev/Desktop/ClaraColour/python/crosstoolsng/openssl-armhf-install", "--openssldir=/usr/lib/ssl", "-march=armv7-a", "-mfpu=neon-vfpv4", "-mfloat-abi=hard", "shared", "no-tests" ],
  perlenv => {
      "AR" => "arm-unknown-linux-gnueabihf-ar",
      "BUILDFILE" => undef,
      "CC" => "arm-unknown-linux-gnueabihf-gcc",
  ...
  prefix => "/home/dev/Desktop/ClaraColour/python/crosstoolsng/openssl-armhf-install",
  processor => "",
